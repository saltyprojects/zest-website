...
const products = [
  ...
  {
    name: 'Fine Finish Industrial Angle Valve (TradeIndia)',
    category: 'Brass Valves',
    desc: 'Premium fine-finish industrial angle valve with precision-machined seating surfaces. Mirror-polished body for high-visibility installations in pharmaceutical, food processing, and commercial buildings.',
    specs: ['Sizes: 15 mm – 50 mm', 'Pressure: PN25 / PN40', 'Material: IS:319 Brass', 'Finish: Mirror Polish'],
    image: '/images/products/fine-finish-industrial-angle-valve-742.jpg',
  },
  {
    name: 'Gun Metal Ball Valve (Screwed Heavy)',
    category: 'Gun Metal Valves',
    desc: 'Heavy-duty screwed gun metal ball valve with reinforced body for marine and industrial applications. Quarter-turn lever operation with blow-out proof stem and double O-ring seal.',
    specs: ['Sizes: 15 mm – 50 mm', 'Pressure: PN25 / PN40', 'Material: Gun Metal LTB2', 'Seat: Reinforced PTFE'],
    image: '/images/products/gun-metal-ball-valve-ti.jpg',
  },
  {
    name: 'Gun Metal Ball Valve (Economy Screwed)',
    category: 'Gun Metal Valves',
    desc: 'Economy-grade gun metal ball valve for general water supply and plumbing applications. Full-bore design with chrome-plated ball and standard PTFE seats.',
    specs: ['Sizes: 15 mm – 40 mm', 'Pressure: PN16', 'Material: Gun Metal LTB2', 'Operation: Quarter Turn'],
    image: '/images/products/gun-metal-ball-valve-ti2.jpg',
  },
  {
    name: 'Gun Metal Ferrule Cock (Heavy Duty)',
    category: 'Gun Metal Cocks',
    desc: 'Heavy-duty gun metal ferrule cock with lock-shield top for tamper-proof water meter connections. Precision-ground taper plug with adjustable gland packing for drip-tight shut-off.',
    specs: ['Sizes: 15 mm – 25 mm', 'Pressure: PN16', 'Material: Gun Metal LTB2', 'Standard: IS:2692'],
    image: '/images/products/gun-metal-ferrule-cock-ti.jpg',
  },
  {
    name: 'Gun Metal Flush Cock (Economy)',
    category: 'Gun Metal Cocks',
    desc: 'Economy-grade self-closing flush cock for public washroom installations. Adjustable flush duration with tamper-proof settings. Chrome lever handle for hygiene compliance.',
    specs: ['Sizes: 25 mm & 32 mm', 'Type: Self-Closing', 'Material: Gun Metal LTB2', 'Flow: Adjustable'],
    image: '/images/products/gun-metal-flush-cock-ti2.jpg',
  },
  {
    name: 'Gun Metal Main Cock (Heavy Pattern)',
    category: 'Gun Metal Cocks',
    desc: 'Heavy-pattern gun metal main cock for underground mains isolation. Extended spindle with surface box adapter for buried installations. Taper plug with renewable packing gland.',
    specs: ['Sizes: 25 mm – 50 mm', 'Pressure: PN16', 'Material: Gun Metal LTB2', 'Type: Underground'],
    image: '/images/products/gun-metal-main-cock-ti.jpg',
  },
  {
    name: 'Gun Metal Tanker Valve (Lever Type)',
    category: 'Gun Metal Valves',
    desc: 'Lever-operated gun metal tanker valve for rapid filling and discharge of water tankers. Large-bore design with quick-opening mechanism for maximum flow capacity.',
    specs: ['Sizes: 50 mm – 100 mm', 'Pressure: PN10 / PN16', 'Material: Gun Metal LTB2', 'Operation: Lever'],
    image: '/images/products/gun-metal-tanker-valve-ti.jpg',
  },
  {
    name: 'Gun Metal Wheel Valve (Economy)',
    category: 'Gun Metal Valves',
    desc: 'Economy-grade gun metal wheel valve for general-purpose flow regulation. Globe pattern with hand wheel operation and rising stem for visual position indication.',
    specs: ['Sizes: 15 mm – 50 mm', 'Pressure: PN16', 'Material: Gun Metal LTB2', 'Type: Globe Pattern'],
    image: '/images/products/gun-metal-wheel-valve-ti.jpg',
  },
  {
    name: 'Gun Metal Gate Valve (Economy)',
    category: 'Gun Metal Valves',
    desc: 'Economy-grade gun metal gate valve for water supply distribution. Non-rising stem with solid wedge gate. Screwed BSP ends for pipeline isolation duty.',
    specs: ['Sizes: 25 mm – 100 mm', 'Pressure: PN16', 'Material: Gun Metal LTB2', 'Ends: Screwed BSP'],
    image: '/images/products/gun-metal-gate-valve-ti.jpg',
  },
  {
    name: 'Gun Metal Pressure Reducing Valve (Compact)',
    category: 'Gun Metal Valves',
    desc: 'Compact pressure reducing valve for space-constrained installations. Direct-acting diaphragm mechanism with adjustable downstream pressure. Integral strainer screen.',
    specs: ['Sizes: 15 mm – 25 mm', 'Inlet: Up to 16 bar', 'Material: Gun Metal LTB2', 'Type: Direct Acting'],
    image: '/images/products/gun-metal-pressure-reducing-valve-ti.jpg',
  },
  {
    name: 'Gun Metal Horizontal O-Ring Valve (Heavy)',
    category: 'Gun Metal Valves',
    desc: 'Heavy-duty horizontal check valve with dual O-ring seal system for enhanced leak prevention. Swing-type disc with guided motion for stable operation at varying flow rates.',
    specs: ['Sizes: 25 mm – 100 mm', 'Seal: Dual O-Ring', 'Material: Gun Metal LTB2', 'Standard: IS:778'],
    image: '/images/products/gun-metal-horizontal-oring.jpg',
  },
  {
    name: 'Gun Metal Bib Ferrule Valve (Premium Screwed)',
    category: 'Gun Metal Valves',
    desc: 'Premium screwed-end bib ferrule valve for water meter and service line installations. Combined isolation and metering access with tamper-proof design.',
    specs: ['Sizes: 15 mm & 20 mm', 'Pressure: PN16', 'Material: Gun Metal LTB2', 'Standard: IS:2692'],
    image: '/images/products/gunmetal-bib-ferrule-ti.jpg',
  },
  {
    name: 'Gun Metal Regulating Valve (Heavy Duty)',
    category: 'Gun Metal Valves',
    desc: 'Heavy-duty gun metal regulating valve for precise flow modulation in waterworks and industrial piping. Globe-type design with fine-thread spindle for accurate throttling control.',
    specs: ['Sizes: 15 mm – 50 mm', 'Pressure: PN25', 'Material: Gun Metal LTB2', 'Type: Globe Pattern'],
    image: '/images/products/gunmetal-regulating-valve-ti.jpg',
  },
  {
    name: 'Brass Angle Valve (Natural Finish)',
    category: 'Brass Valves',
    desc: 'Natural brass finish angle valve for concealed plumbing and wall-mount installations. Precision-machined disc seat for drip-tight shut-off. Quarter-turn ceramic disc option available.',
    specs: ['Sizes: 15 mm – 25 mm', 'Pressure: PN16', 'Material: IS:319 Brass', 'Finish: Natural Brass'],
    image: '/images/products/brass-angle-valve-im.jpg',
  },
  {
    name: 'Brass Wheel Valve (Industrial)',
    category: 'Brass Valves',
    desc: 'Industrial-grade brass wheel valve for process piping, HVAC, and steam applications. Rising stem with visual position indicator and renewable disc seat.',
    specs: ['Sizes: 15 mm – 50 mm', 'Pressure: PN25', 'Material: IS:319 Brass', 'Type: Rising Stem Globe'],
    image: '/images/products/brass-wheel-valve-ti.jpg',
  },
  {
    name: 'Brass Union (Economy)',
    category: 'Brass Fittings',
    desc: 'Economy-grade brass union for residential plumbing and light commercial pipeline connections. Three-piece design with fibre washer seal for easy joint disassembly.',
    specs: ['Sizes: 15 mm – 40 mm', 'Pressure: PN10', 'Material: IS:319 Brass', 'Thread: BSP'],
    image: '/images/products/brass-union-ti2.jpg',
  },
  {
    name: 'Brass Bib Cock (Chrome Finish)',
    category: 'Brass Cocks',
    desc: 'Chrome-finished brass bib cock for premium residential and commercial washroom installations. T-handle with wall-mount flange plate. Washer-type shut-off mechanism.',
    specs: ['Sizes: 15 mm', 'Pressure: PN10', 'Material: IS:319 Brass', 'Finish: Chrome Plated'],
    image: '/images/products/brass-bib-cock-ti2.jpg',
  },
  {
    name: 'Industrial Angle Valve (Heavy Pattern)',
    category: 'Brass Valves',
    desc: 'Heavy-pattern industrial angle valve for boiler blowdown, steam service, and high-pressure process piping. Bolted bonnet with integral back-seat and renewable disc.',
    specs: ['Sizes: 25 mm – 50 mm', 'Pressure: PN40', 'Material: IS:319 Brass', 'Thread: BSP / NPT'],
    image: '/images/products/industrial-angle-valve-ti2.jpg',
  },
  {
    name: 'Gun Metal Vertical O-Ring Valve (Heavy)',
    category: 'Gun Metal Valves',
    desc: 'Heavy-pattern vertical check valve with O-ring seal for high-rise building water supply risers. Enhanced seating for positive backflow prevention at low flow differentials.',
    specs: ['Sizes: 25 mm – 80 mm', 'Seal: O-Ring', 'Material: Gun Metal LTB2', 'Standard: IS:778'],
    image: '/images/products/gun-metal-vertical-oring-ti.jpg',
  },
  {
    name: 'Gun Metal Horizontal Check Valve (Economy)',
    category: 'Gun Metal Valves',
    desc: 'Economy-grade horizontal swing check valve for general water supply and plumbing applications. Sand-cast body with machined BSP threads and renewable disc.',
    specs: ['Sizes: 25 mm – 80 mm', 'Pressure: PN16', 'Material: Gun Metal LTB2', 'Standard: IS:778'],
    image: '/images/products/gun-metal-horizontal-check-valve-ti.jpg',
  },
  {
    name: 'Gun Metal Union Cap (Economy)',
    category: 'Gun Metal Valves',
    desc: 'Economy-grade gun metal union cap for pipeline end closure. Screwed BSP connection with hexagonal body for easy wrench operation. Suitable for temporary and permanent pipe termination.',
    specs: ['Sizes: 15 mm – 50 mm', 'Pressure: PN16', 'Material: Gun Metal LTB2', 'Thread: BSP'],
